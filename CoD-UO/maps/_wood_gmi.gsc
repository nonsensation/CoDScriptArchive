/*###################################################
		...
		5) Exec this script at the start of your level - "maps\_wood_gmi::main();"
###################################################*/

main()
{
	maps\_utility_gmi::precache ("xmodel/woodgib_medium");
	maps\_utility_gmi::precache ("xmodel/woodgib_big");
	maps\_utility_gmi::precache ("xmodel/woodgib_small1");
	maps\_utility_gmi::precache ("xmodel/woodgib_small2");
	
	maps\_utility_gmi::precache ("xmodel/wood_plank2");
	maps\_utility_gmi::precache ("xmodel/gib_woodplank");
	
	wood = getentarray ("wood_splinter","targetname");
	maps\_utility_gmi::array_thread(wood, ::wood_think);
}
