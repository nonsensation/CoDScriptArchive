main()
{
	...
	{
//		maps\_utility_gmi::error ("LOADING SOUNDS");
		...
		maps\_fx_gmi::loopSound("bigfire", (-4292, 544, 332), 12.07);
		maps\_fx_gmi::loopSound("bigfire", (-4543, 1063, 567), 12.07);
	}
	...
	if (level.script == "burnville")
	{
		...
		maps\_fx_gmi::loopSound("medfire", (-781, 17970, 91), 12.07);
		maps\_fx_gmi::loopSound("bigfire", (2100, -16243, -7), 12.07);
	}
...
//		level.scr_sound ["plane25"] = "stalingrad_flyover4"; // Plane flyby
	...
	maps\_fx_gmi::loopSound("sewer_water", (3092, 749, -473), 15.23);
	maps\_fx_gmi::loopSound("sewer_water", (4694, 139, -378), 15.23);
	maps\_fx_gmi::loopSound("sewer_water", (2672, 2566, -319), 15.23);
	maps\_fx_gmi::loopSound("wind_whistle", (2257, 951, -264), 32.18);
	maps\_fx_gmi::loopSound("wind_whistle", (5277, -2347, -93), 32.18);
	maps\_fx_gmi::loopSound("wind_whistle", (3384, 2720, 55), 32.18);
	maps\_fx_gmi::loopSound("wind_whistle", (4985, -1121, -245), 32.18);
	...
	maps\_fx_gmi::loopSound("waterfall_dam", (-21126, 3695, -1513), 22.10);
	maps\_fx_gmi::loopSound("waterfall_dam2", (-23235, 3611, -1513), 22.10);
	maps\_fx_gmi::loopSound("generator", (-21822, 3372, -1535), 13.39);
	maps\_fx_gmi::loopSound("searchlight", (-18474, 3157, 34), 8.35);
	maps\_fx_gmi::loopSound("searchlight", (-28925, 4191, 34), 8.35);
	maps\_fx_gmi::loopSound("searchlight", (-21478, -228, -150), 8.35);
	maps\_fx_gmi::loopSound("waterlap", (-18324, 5657, -73), 15.39);
	maps\_fx_gmi::loopSound("waterlap", (-24359, 1236, -1668), 15.39);
	maps\_fx_gmi::loopSound("waterlap", (-21818, -8, -1738), 15.39);
	maps\_fx_gmi::loopSound("waterlap", (-22639, 747, -1700), 15.39);
	maps\_fx_gmi::loopSound("waterlap", (-19344, 4543, -75), 15.39);
	maps\_fx_gmi::loopSound("waterlap", (-20688, 5144, -47), 15.39);
	maps\_fx_gmi::loopSound("waterlap", (-27895, 4900, -33), 15.39);
	maps\_fx_gmi::loopSound("waterlap", (-22440, 5654, -40), 15.39);
	maps\_fx_gmi::loopSound("waterlap", (-24252, 5721, -58), 15.39);
	maps\_fx_gmi::loopSound("waterlap", (-22117, 2464, -1699), 15.39);
	maps\_fx_gmi::loopSound("german_radio", (-27343, 4682, -8), 60.27);
	...
	maps\_fx_gmi::loopSound("boiler", (3721, -208, -207), 15.23);
	maps\_fx_gmi::loopSound("boiler", (3702, 245, 207), 15.23);
	...
	maps\_fx_gmi::loopSound("german_radio", (10589, 4477, 248), 60.27);
	maps\_fx_gmi::loopSound("german_radio", (10663, 6741, 315), 60.27);
	...
	maps\_fx_gmi::loopSound("german_radio", (3418, 1015, -207), 60.27);
	...
	maps\_fx_gmi::loopSound("german_radio", (-1984, 4758, -123), 60.27);
	maps\_fx_gmi::loopSound("smallfire", (-1880, 4619, -137), 5.27);
	...
	maps\_fx_gmi::loopSound("german_radio", (-1973, 4260, -7), 60.27);
	...
	maps\_fx_gmi::loopSound("killfire", (3691, 13259, 83), .50);
	maps\_fx_gmi::loopSound("killfire", (3890, 13398, 268), .50);
	maps\_fx_gmi::loopSound("killfire", (4140, 13154, 20), .50);
	maps\_fx_gmi::loopSound("killfire", (4102, 13277, 284), .50);
	maps\_fx_gmi::loopSound("killfire", (4685, 13378, 10), .50);
