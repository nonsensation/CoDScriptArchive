getnames(num)
{
	...
	{
		savedescription = &"AUTOSAVE_PATHFINDER";
		if (num == 1)
			savedescription = &"AUTOSAVE_PATHFINDER1";
		if (num == 2)
			savedescription = &"AUTOSAVE_PATHFINDER2";
		return savedescription;
	}
	...
	if (level.script == "stalingrad")
	{
		...
		if (num == 2)
			savedescription = &"AUTOSAVE_STALINGRAD1";
		if (num == 3)
			savedescription = &"AUTOSAVE_STALINGRAD2";
		if (num == 4)
			savedescription = &"AUTOSAVE_STALINGRAD3";
	...
	if ((level.script == "redsquare"))
	{
		...
		if (num == 5)
		{
			savedescription = &"AUTOSAVE_REDS4";
			return savedescription;
		}
	}
	...
	if ((level.script == "pavlov"))
	{
		...
		if (num == 5)
		{
			savedescription = &"AUTOSAVE_PAVLOV4";
			return savedescription;
		}
	}
