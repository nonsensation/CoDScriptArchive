...
get_american_name()
{
	switch (game["americannames"])
	{
		...
		case 139: self.name = "Kirshenbaum";break;
		...
		case 150: self.name = "Saltzman"; game["americannames"] = 0;break;
	}
...
get_british_name()
{
	switch (game["britishnames"])
	{
		...
		case  141: self.name = "Pvt. Ricketts"; game["britishnames"] = 0;break;
	}
}
...
get_russian_name()
{
	switch (game["russiannames"])
	{
		...
		case  139: self.name = "Pvt. Semenov"; game["russiannames"] = 0;break;
	}
}