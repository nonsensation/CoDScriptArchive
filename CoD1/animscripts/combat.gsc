...
ShootVolley(completeLastShot, forceShoot, posOverrideEntity )
{
	...
	if (animscripts\weaponList::usingAutomaticWeapon())
	{
		...
		/#[[anim.locSpam]]("c16a");#/
		/#[[anim.println]]("enemyDistanceSq: ",self.enemyDistanceSq,", meleeRangeSq: ",anim.meleeRangeSq);#/
		/#[[anim.println]]("forceShoot: ",forceShoot);#/
...
DoAutofire(notifystring, numshots, forceShoot)
{
	...
	/#[[anim.println]]("enemyAngle: ",enemyAngle);#/
