...
main()
{
	...
	endPos = self getnegotiationendpos() + (0,0,1);	// 1 unit padding
	...
	/#[[anim.println]]("stairs_down: about to start climbing.  Horizontal dist: " +horizontalDistance+ ", dist/cycle: "+cycleHorDist+", time/cycle: "+cycleTime+", time to play: "+climbingTime);#/
...
//	self setAnimKnobAllRestart(self.anim_crouchrunanim, %body, 1, 0.1, 1);
	/#[[anim.println]]("stairs_up: all done");#/
}
