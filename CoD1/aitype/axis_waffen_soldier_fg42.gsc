...
/*QUAKED actor_axis_waffen_soldier_fg42 (1.0 0.25 0.0) (-16 -16 0) (16 16 72) SPAWNER FORCESPAWN UNDELETABLE NOENEMYINFO
...
main()
{
	...
	character\waffenSS_soldier::main();
}
...
precache()
{
	character\waffenSS_soldier::precache();
