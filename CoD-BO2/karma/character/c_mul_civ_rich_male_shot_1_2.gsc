...
main()
{
	codescripts/character::setmodelfromarray( xmodelalias/c_mul_civ_rich_male_shot_up2_als::main() );
...
precache()
{
	codescripts/character::precachemodelarray( xmodelalias/c_mul_civ_rich_male_shot_up2_als::main() );
