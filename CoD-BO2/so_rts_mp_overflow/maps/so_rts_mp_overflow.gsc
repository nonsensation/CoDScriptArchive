#include maps/so_rts_mp_overflow_s1;
...
main()
{
	...
	maps/so_rts_mp_overflow_fx::main();
	level.rts_def_table = "sp/so_rts/mp_overflow_rts.csv";
	maps/_so_rts_main::preload();
	level.compass_map_name = "compass_map_mp_overflow";
...
overflow_level_setup()
{
	level.onspawnplayer = ::overflow_setstart;
	switch( getDvarInt( "map_scenario" ) )
	{
		case 0:
		case 1:
			level.custom_mission_complete = ::maps/so_rts_mp_overflow_s1::overflow_mission_complete_s1;
			level thread maps/so_rts_mp_overflow_s1::overflow_level_scenario_one();
			break;
		case 2:
			case 3:
				default:
...
overflow_level_precache()
{
	...
	switch( getDvarInt( "map_scenario" ) )
	{
		case 0:
		case 1:
			level thread maps/so_rts_mp_overflow_s1::precache();
			break;
		case 2:
			case 3:
				default:
