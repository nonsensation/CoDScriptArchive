...
main()
{
	self setmodel( "c_afg_muhajadeen_body_2_2" );
	...
	self.skeleton = "base";
	self.torsodmg1 = "c_afg_muhaj_body_2_2_g_upclean";
	self.torsodmg2 = "c_afg_muhaj_body_2_2_g_rarmoff";
	self.torsodmg3 = "c_afg_muhaj_body_2_2_g_larmoff";
	self.legdmg1 = "c_afg_muhaj_body_2_2_g_lowclean";
	self.legdmg2 = "c_afg_muhaj_body_2_2_g_rlegoff";
	self.legdmg3 = "c_afg_muhaj_body_2_2_g_llegoff";
	self.legdmg4 = "c_afg_muhaj_body_2_2_g_legsoff";
...
precache()
{
	precachemodel( "c_afg_muhajadeen_body_2_2" );
	...
	precachemodel( "c_afg_muhaj_body_2_2_g_upclean" );
	precachemodel( "c_afg_muhaj_body_2_2_g_rarmoff" );
	precachemodel( "c_afg_muhaj_body_2_2_g_larmoff" );
	precachemodel( "c_afg_muhaj_body_2_2_g_lowclean" );
	precachemodel( "c_afg_muhaj_body_2_2_g_rlegoff" );
	precachemodel( "c_afg_muhaj_body_2_2_g_llegoff" );
	precachemodel( "c_afg_muhaj_body_2_2_g_legsoff" );
