...
main()
{
	...
	self.voice = "russian";
	self.skeleton = "base";
	self.torsodmg1 = "c_rus_afghan_spetsnaz_body1_g_upclean";
	self.torsodmg2 = "c_rus_afghan_spetsnaz_body1_g_rarmoff";
	self.torsodmg3 = "c_rus_afghan_spetsnaz_body1_g_larmoff";
	self.torsodmg5 = "c_rus_afghan_spetsnaz_body1_g_behead";
...
precache()
{
	...
	precachemodel( "c_rus_afghan_spetsnaz_body1_g_upclean" );
	precachemodel( "c_rus_afghan_spetsnaz_body1_g_rarmoff" );
	precachemodel( "c_rus_afghan_spetsnaz_body1_g_larmoff" );
	precachemodel( "c_rus_afghan_spetsnaz_body1_g_behead" );
