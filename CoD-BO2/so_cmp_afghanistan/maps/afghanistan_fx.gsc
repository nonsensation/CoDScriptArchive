...
precache_util_fx()
{
	level.mortar = loadfx( "maps/afghanistan/fx_afgh_mortar" );
...
precache_scripted_fx()
{
	...
	level._effect[ "fx_afgh_rappel_impact_lg" ] = loadfx( "env/dirt/fx_afgh_rappel_impact_lg" );
	...
	level._effect[ "explode_mortar_sand" ] = loadfx( "maps/afghanistan/fx_afgh_mortar" );
	level._effect[ "explode_mortar_sand_short" ] = loadfx( "maps/afghanistan/fx_afgh_mortar_short" );
	...
	level._effect[ "rock_fall" ] = loadfx( "impacts/fx_afgh_xlg_rock" );
	...
	level._effect[ "t62_tank_damage" ] = loadfx( "vehicle/vexplosion/fx_vexp_t62_damage" );
	...
	level._effect[ "numbers_strong" ] = loadfx( "maps/afghanistan/fx_afgh_interrog_numbers_strong" );
	...
	level._effect[ "numbers_close" ] = loadfx( "maps/afghanistan/fx_afgh_interrog_numbers_close" );
	level._effect[ "numbers_close_os" ] = loadfx( "maps/afghanistan/fx_afgh_interrog_numbers_close_os" );
	level._effect[ "numbers_final" ] = loadfx( "maps/afghanistan/fx_afgh_interrog_numbers_finale" );
	...
	level._effect[ "sand_body_impact_sm" ] = loadfx( "env/dirt/fx_afgh_sand_body_impact_sm" );
	...
	level._effect[ "head_shot_woods" ] = loadfx( "maps/afghanistan/fx_afgh_head_shot_woods" );
	level._effect[ "player_muzzle_flash" ] = loadfx( "maps/afghanistan/fx_afgh_interrog_muz_flash" );
...
initmodelanims()
{
	...
	maps/_anim::addnotetrack_customfunction( "fxanim_props", "boulder_impact_01", ::rock_slide_fx, "rock_slide" );
	maps/_anim::addnotetrack_customfunction( "fxanim_props", "boulder_impact_02", ::rock_slide_fx, "rock_slide" );
	maps/_anim::addnotetrack_customfunction( "fxanim_props", "boulder_impact_03", ::rock_slide_fx, "rock_slide" );
	maps/_anim::addnotetrack_customfunction( "fxanim_props", "boulder_impact_04", ::rock_slide_fx, "rock_slide" );
	maps/_anim::addnotetrack_customfunction( "fxanim_props", "boulder_impact_05", ::rock_slide_fx, "rock_slide" );
	maps/_anim::addnotetrack_customfunction( "fxanim_props", "boulder_impact_06", ::rock_slide_fx, "rock_slide" );
}

rock_slide_fx( entity )
{
	if ( !isDefined( level.fxanim_rock_tags ) )
	{
		level.fxanim_rock_tags = [];
		level.fxanim_rock_tags[ 0 ] = "tag_fx_boulder_impact1";
		level.fxanim_rock_tags[ 1 ] = "tag_fx_boulder_impact2";
		level.fxanim_rock_tags[ 2 ] = "tag_fx_boulder_impact3";
		level.fxanim_rock_tags[ 3 ] = "tag_fx_boulder_impact4";
		level.fxanim_rock_tags[ 4 ] = "tag_fx_boulder_impact5";
		level.fxanim_rock_tags[ 5 ] = "tag_fx_boulder_impact6";
		level.fxanim_rock_index = 0;
	}
	playfxontag( level._effect[ "rock_fall" ], entity, level.fxanim_rock_tags[ level.fxanim_rock_index ] );
	level.fxanim_rock_index++;
	if ( level.fxanim_rock_index == level.fxanim_rock_tags.size )
	{
		level.fxanim_rock_tags = undefined;
		level.fxanim_rock_index = undefined;
	}
}
...
precache_createfx_fx()
{
	...
	level._effect[ "fx_afgh_god_ray_sm" ] = loadfx( "maps/afghanistan/fx_afgh_god_ray_sm" );
	level._effect[ "fx_afgh_god_ray_md" ] = loadfx( "maps/afghanistan/fx_afgh_god_ray_md" );
	level._effect[ "fx_afgh_god_ray_lg" ] = loadfx( "maps/afghanistan/fx_afgh_god_ray_lg" );
	level._effect[ "fx_lf_afgh_sun" ] = loadfx( "lens_flares/fx_lf_afgh_sun" );
	level._effect[ "fx_lf_afgh_sun_intro" ] = loadfx( "lens_flares/fx_lf_afgh_sun_intro" );
	...
	level._effect[ "fx_afgh_fire_smolder" ] = loadfx( "maps/afghanistan/fx_afgh_fire_smolder" );
	level._effect[ "fx_afgh_plume_smk_lrg" ] = loadfx( "maps/afghanistan/fx_afgh_plume_smk_lrg" );
	level._effect[ "fx_afgh_plume_smk_med" ] = loadfx( "maps/afghanistan/fx_afgh_plume_smk_med" );
	level._effect[ "fx_afgh_plume_smk_sm" ] = loadfx( "maps/afghanistan/fx_afgh_plume_smk_sm" );
	level._effect[ "fx_afgh_sand_peak" ] = loadfx( "maps/afghanistan/fx_afgh_sand_peak" );
	level._effect[ "fx_afgh_explo_base_wall" ] = loadfx( "maps/afghanistan/fx_afgh_explo_base_wall" );
	level._effect[ "fx_afgh_fire_base_wall" ] = loadfx( "maps/afghanistan/fx_afgh_fire_base_wall" );
...
main()
{
	...
	initmodelanims();
	footsteps();
	maps/createfx/so_cmp_afghanistan_fx::main();
	wind_initial_setting();
}
