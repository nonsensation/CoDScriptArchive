...
riverbed_intro_buffel( m_pristine_window, a_buffel_cracked_windshields )
{
	...
	_a349 = hack_windows;
	_k349 = getFirstArrayKey( _a349 );
	while ( isDefined( _k349 ) )
	{
		window = _a349[ _k349 ];
		window delete();
		_k349 = getNextArrayKey( _a349, _k349 );
	}
}
...
riverbed_convoy()
{
	...
	while ( !flag( "savannah_base_reached" ) )
	{
		...
		_a810 = a_nd_random;
		_k810 = getFirstArrayKey( _a810 );
		while ( isDefined( _k810 ) )
		{
			nd = _a810[ _k810 ];
			...
			_k810 = getNextArrayKey( _a810, _k810 );
		}
	}
}
