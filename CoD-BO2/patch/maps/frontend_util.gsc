...
build_globe()
{
	...
	_a1374 = countries;
	_k1374 = getFirstArrayKey( _a1374 );
	while ( isDefined( _k1374 ) )
	{
		country = _a1374[ _k1374 ];
		country linkto( globe );
		country hide();
		country ignorecheapentityflag( 1 );
		country clearclientflag( 14 );
		_k1374 = getNextArrayKey( _a1374, _k1374 );
	}
...
show_globe( do_show, toggle_countries, ambient_spin )
{
	...
	while ( toggle_countries || ambient_spin )
	{
		countries = getentarray( globe.target, "targetname" );
		_a1483 = countries;
		_k1483 = getFirstArrayKey( _a1483 );
		while ( isDefined( _k1483 ) )
		{
			country = _a1483[ _k1483 ];
			...
			_k1483 = getNextArrayKey( _a1483, _k1483 );
		}
	}
}
