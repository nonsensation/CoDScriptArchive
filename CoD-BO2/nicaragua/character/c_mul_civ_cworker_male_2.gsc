...
main()
{
	codescripts/character::setmodelfromarray( xmodelalias/c_mul_civ_cwrkr_male_body2_als::main() );
...
precache()
{
	codescripts/character::precachemodelarray( xmodelalias/c_mul_civ_cwrkr_male_body2_als::main() );
