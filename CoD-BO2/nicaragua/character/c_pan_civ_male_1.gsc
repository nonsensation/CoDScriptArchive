...
main()
{
	codescripts/character::setmodelfromarray( xmodelalias/c_pan_civ_male_body1_als::main() );
...
precache()
{
	codescripts/character::precachemodelarray( xmodelalias/c_pan_civ_male_body1_als::main() );
