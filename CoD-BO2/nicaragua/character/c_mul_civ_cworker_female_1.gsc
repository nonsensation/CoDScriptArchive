...
main()
{
	codescripts/character::setmodelfromarray( xmodelalias/c_mul_civ_cwrkr_female_body1_als::main() );
...
precache()
{
	codescripts/character::precachemodelarray( xmodelalias/c_mul_civ_cwrkr_female_body1_als::main() );
