...
main()
{
	codescripts/character::setmodelfromarray( xmodelalias/c_mul_civ_cwrkr_male_body3_als::main() );
...
precache()
{
	codescripts/character::precachemodelarray( xmodelalias/c_mul_civ_cwrkr_male_body3_als::main() );
